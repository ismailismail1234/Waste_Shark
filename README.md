Waste Shark – Remote Controlled Aquatic Cleaning Robot
📌 Project Overview
...
The system is based on a microcontroller that receives control commands from a smartphone via a RemoteXY interface. These commands are used to control the robot’s motion and operational behavior.
...
│
├── main/
│   └── main.ino                 # Main Arduino control code
│
├── images/
│   ├── Control Configuration.jpg
│   └── waste_shark_prove_of_concept.jpg
│
└── README.md
...
👤 Author:- Ismail Ismail Ibrahim adam
